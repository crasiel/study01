	      ...
	      <ul class="nav navbar-nav navbar-right">
            ...
            <c:if test="${!empty mvo }">
			  	<c:if test="${empty mvo.memProfile}">
			  		<li><img src="${path }/resources/images/person.png" class="img-circle" style="width : 50px; height : 50px;"> ${mvo.memName }님 Welcome.</li>
			  	</c:if>
			  	<c:if test="${!empty mvo.memProfile}">
			  		<li><img src="${path }/resources/upload/${mvo.memProfile}" class="img-circle" style="width : 50px; height : 50px"> ${mvo.memName }님 Welcome.</li>
			  	</c:if>
			</c:if>
	      </ul>
      </c:if>
