...
<jsp:include page="../common/header.jsp" /> 
  ...
  <div class="panel panel-info">
    ...
    <div class="panel-body">
    	<form name="frm" action="${path }/memLogin.do" id="" method="post">
    		<table class="table table-bordered" style="text-align : center; border: 1px solid #ddd">
    				...
    				<tr>
    					...
    					<td colspan="2"><input type="password" name="memPassword" id="memPassword" class="form-control" maxlength="20" placeholder="비밀번호를 입력하세요."></td>
    				</tr>
    				<tr>
    					<td colspan="3" style="text-align:center;">
    						<a class="btn btn-info btn-sm pull-right" style="margin-left : 10px;" href="${path}/memJoin.do">회원가입</a>
