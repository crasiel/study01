	...
	function makeView(data){		// data = [{ },{ },{ },....]
		...
		$.each(data,function(index, obj){
			...
			if("${mvo.memId}" == obj.memId){
				...
				listHtml += "<br>";
				listHtml += "<span id='ub" + obj.idx + "'><button class='btn btn-success btn-sm' onclick='goUpdateForm(" + obj.idx + ")' disabled>수정화면</button></span>&nbsp;&nbsp;";
		...
		if(${!empty mvo}){
			listHtml += "<tr>";
			listHtml += "<td colspan='5'  style='border-bottom : none;'>";
  ...
  <div class="panel panel-info">
    ...
    <div class="panel-body" id="wform" style="display: none;">
		...
		<table class="table table-bordered">
			...
			<tr>
				<td>작성자</td>
				<td><input type="text" name="writer" id="writer" class="form-control" value="${mvo.memName }" readonly></td>
			</tr>
			<tr>
